...
export const DEFAULT_COLOR: ColorKeys = "defaultColor";
...
export const BG_COLOR: Colors = {
    ...
    hover: {
        ...
        primaryColor: "hover:bg-background-600",
        defaultColor: "bg-primary"
    }
};
...
export const TEXT_COLOR: Colors = {
    ...
    hover: {
        ...
        primaryColor: "hover:currentColor",
        defaultColor: "bg-primary"
    }
};
...
export const BORDER_COLOR: Colors = {
    500: {
        ...
        primaryColor: "border-currentColor",
        defaultColor: "bg-primary"
    },
    focus: {
        ...
        primaryColor: "focus:currentColor",
        defaultColor: "bg-primary"
    }
};
...
export const RING_COLOR: Colors = {
    focus: {
        ...
        primaryColor: "focus:ring-currentColor",
        defaultColor: "bg-primary"
    },
    "second-focus": {
        ...
        primaryColor: "focus:ring-rose-currentColor-500/20",
        defaultColor: "bg-primary"
    }
};
...
export const BUTTON_COLOR: Colors = {
    focus: {
        ...
        primaryColor: "focus:ring-currentColor-500/50 focus:bg-rose-100/50",
        defaultColor: "bg-primary"
    }
};
