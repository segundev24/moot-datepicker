    ...
    return (
        <DatepickerContext.Provider value={contextValues}>
            <div className={containerClassNameOverload} ref={containerRef}>
                ...
                <div
                    className="transition-all ease-out  duration-300 absolute z-10 mt-[1px] text-sm lg:text-xs 2xl:text-sm translate-y-4 opacity- hidden"
                ...
                >
                    ...
                    <div
                        ...
                        className="mt-2.5 shadow-sm border border-gray-300 px-1 py-0.5 dark:text-white dark:border-slate-600 rounded-lg"
                    >
